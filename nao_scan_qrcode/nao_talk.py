...
class NaoDialogs:
    ...
    def intro_interest(self):
        speech_interests = ["I see that you are interested in the ",
                            ...
                            "So your interests lies within the "]
    ...
    def interest_talk(self, json_value):
            ...
            if json_value == "Artist":
                ...
                " fame and recognition beforehe turned thirty? He was mostly"\
                ...
                " once. Pierogies is kind of dough filled with different fillings."\
