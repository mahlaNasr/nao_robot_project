...
This project proposes a system where humanoid robot, NAO, is used to scan QR code tickets in [**the National Portrait Gallery**](https://www.nationalgallery.org.uk/whats-on/national-gallery-x) art museum.
